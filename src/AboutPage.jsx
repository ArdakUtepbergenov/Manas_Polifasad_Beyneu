            ...
            <div className="lg:col-span-6 lg:col-start-7">
              ...
              <Reveal delay={280}>
                <div className="mt-10 grid grid-cols-2 gap-4">
                  ...
                  <Pillar value="04" label="Гарантия 25 лет" text="Письменное обязательство на материал и работу."/>
                </div>
              </Reveal>
            </div>
          </div>
...
function GuaranteesSection() {
  const items = [
    { icon: 'Shield',    title: '25 лет на материал', text: 'Цветостойкость, морозостойкость и геометрическая стабильность. Гарантия фиксируется письменно в договоре.' },
    { icon: 'Wrench',    title: '10 лет на монтаж',   text: 'Качество узлов крепления, герметизация швов, ветрозащита. Бесплатный сервис в течение всего срока.' },
...
function ProductionTimeline() {
  const events = [
    ...
    { year: '2020', text: 'Расширение производства до 12 000 м² панелей в год. Гарантия увеличена до 25 лет.' },
